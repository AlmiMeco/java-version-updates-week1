...
/** Example of bad principle adherence to "Single Responsibility": ------------------------------>
 * 'User' class has the duty (responsibility) of too many functions (methods) :  ---------------->
  these functions MUST be compartmentalized into different Classes to follow SOLID Principles **/
